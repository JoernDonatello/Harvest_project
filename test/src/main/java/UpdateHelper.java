 ...
 * @author Jörn
 */
public class UpdateHelper extends javax.swing.JFrame {
...
public static void setHelper(int helperID)
{
    
    tfPrename.setText(HelperManager.myHelpers.get(helperID).getPrename());
    ...
    private void updateBerry(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBerry
        ...
        i.setPrename(tfPrename.getText());
        i.setSurname(tfSurname.getText());
        i.setGender(cbGender.getSelectedItem().toString());
        }
    ...
    private void tfSurnameClick(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tfSurnameClick
        tfSurname.setText("");
    }//GEN-LAST:event_tfSurnameClick
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateHelper.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateHelper().setVisible(true);
            }
        });
    }
